...
PROJECT_NAME ?= provider-anypoint
PROJECT_REPO ?= github.com/basb2801/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_SOURCE ?= mulesoft-anypoint/anypoint
export TERRAFORM_PROVIDER_REPO ?= https://github.com/mulesoft-anypoint/terraform-provider-anypoint
export TERRAFORM_PROVIDER_VERSION ?= 1.8.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= mulesoft-anypoint
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-mulesoft-anypoint_v1.8.0
...
xpkg.build.provider-anypoint: do.build.images
