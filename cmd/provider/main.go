...
import (
	...
	"github.com/basb2801/provider-anypoint/apis"
	"github.com/basb2801/provider-anypoint/apis/v1alpha1"
	"github.com/basb2801/provider-anypoint/config"
	"github.com/basb2801/provider-anypoint/internal/clients"
	"github.com/basb2801/provider-anypoint/internal/controller"
	"github.com/basb2801/provider-anypoint/internal/features"
)

func main() {
	var (
		app                     = kingpin.New(filepath.Base(os.Args[0]), "Terraform based Crossplane provider for Anypoint").DefaultEnvars()
	...
	log := logging.NewLogrLogger(zl.WithName("provider-anypoint"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-anypoint",
		Cache: cache.Options{
	...
	kingpin.FatalIfError(apis.AddToScheme(mgr.GetScheme()), "Cannot add Anypoint APIs to scheme")
	...
	kingpin.FatalIfError(controller.Setup(mgr, o), "Cannot setup Anypoint controllers")
